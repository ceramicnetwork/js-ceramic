...
const genIpfsConf = (path: string, id: string): any => {
  return {
    repo: `${path}/ipfs${id}/`,
    config: {
...
describe('Ceramic integration', () => {
  ...
  describe('can propagate update', () => {
    it('across two connected nodes', async () => {
  ...
  describe('won\'t propagate update', () => {
    it('across two disconnected nodes', async () => {
      const ceramic1 = await Ceramic.create(ipfs1)
  ...
  describe('can propagate update', () => {
    it('across nodes with common connection', async () => {
      // ipfs1 <-> ipfs2 <-> ipfs3
      // ipfs1 <!-> ipfs3
  ...
  describe('can propagate multiple update', () => {
    it('across nodes with common connection', async () => {
      // ipfs1 <-> ipfs2 <-> ipfs3
      // ipfs1 <!-> ipfs3
      await ipfs1.swarm.connect(multaddr2)
