...
test.todo('handles basic conflict');
test.todo('handles consecutive anchors');
test.todo('enforces schema at document creation');
test.todo('enforces schema in update that assigns schema');
test.todo('Enforces previously assigned schema during future update');
test.todo('should announce change to network');
