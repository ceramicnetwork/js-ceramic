...
program
    ...
    .action(async ({ ipfsApi, ethereumRpc, anchorServiceApi, stateStorePath, validateDocs }) => {
...
program
    ...
    .action(async (doctype, { content, onlyGenesis, owners, unique, schema }) => {
        await Utils.createDoc(doctype, content, owners, onlyGenesis, unique, schema)
    })
...
program
    ...
    .action(async (docId, { content, owners, schema }) => {
        await Utils.change(docId, content, owners, schema)
    })
...
schemas
    ...
    .action(async (content, { onlyGenesis, owners, unique }) => {
        await Utils.schemaCreateDoc(content, owners, onlyGenesis, unique)
    })
...
schemas
    ...
    .action(async (docId, content, { owners }) => {
        await Utils.schemaChangeDoc(docId, content, owners)
    })
...
schemas
    ...
    .action(async (schemaDocId, content) => {
        await Utils.schemaValidateContent(schemaDocId, content)
    })
