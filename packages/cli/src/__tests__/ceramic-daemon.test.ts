...
describe('Ceramic interop: core <> http-client', () => {
    ...
    it('loads commits correctly', async () => {
        ...
        // Load genesis commit
        const v0Id = doc.id.travel(doc.id.cid)
        ...
        const v1Id = doc.id.travel(doc.state.log[1].cid)
        ...
        // Load v2
        const v2Id = doc.id.travel(doc.state.log[2].cid)
        ...
        const v3Id = doc.id.travel(doc.state.log[3].cid)
        ...
        // Load v4
        const v4Id = doc.id.travel(doc.state.log[4].cid)
        ...
        // Load v5
        const v5Id = doc.id.travel(doc.state.log[5].cid)
