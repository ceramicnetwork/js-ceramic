...
export class CeramicDaemon {
    ...
    if (modelsValidation.error) {
      ...
      if (authHeaderValidation.error) {
        ...
        try {
          ...
          console.log('WILL CALL SUCCESS CALLBACK', authHeaderValidation, modelIDs)
  ...
  async addModelsToIndex(req: Request, res: Response): Promise<void> {
    await this._processAdminModelsMutationRequest(req, res, this.ceramic.admin.addModelsToIndex)
  }

  async removeModelsFromIndex(req: Request, res: Response): Promise<void> {
    await this._processAdminModelsMutationRequest(req, res, this.ceramic.admin.removeModelsFromIndex)
  }

  async replaceModelsInIndex(req: Request, res: Response): Promise<void> {
    await this._processAdminModelsMutationRequest(req, res, this.ceramic.admin.replaceModelsInIndex)
  }
